    ...
    <body id="body-pd" style="background-color: #F7F6FB;">
        ...
        <script>
            ...
            function deleteConfirm($id) {
                Swal.fire({
                    ...
                    if(result.isConfirmed) {
                        window.location.replace('/admin/usuarios/eliminar/'+$id)
                    }
                })
            }
            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav_list">
                        ...
                        <a href="/admin/usuarios" class="nav_link active">
        ...
        <div class=" bg-light">
            ...
            <div class="d-flex justify-content-between my-3 mx-3">
                ...
                <a href="/admin/usuarios/crear" class="btn btn-outline-secondary btn-add" >
                    <i class="bx bx-plus nav_icon" style="vertical-align: sub;"></i>Nuevo Usuario
                </a>
            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h6 class="fw-semibold">{{ $user->correo }}</h6>
                                    <h6 class="fw-semibold">{{ $user->idRol == '1' ? 'Admin' : 'Cliente' }}</h6>
                                    <h6>Fecha creación: {{ $user->created_at }}</h6>
                                    <h6>Última modificación: {{ $user->updated_at }}</h6>
                                </div>
                                <div>
                                    <a class="btn btn-outline-primary btn-edit" href="/admin/usuarios/editar/{{$user->id}}">
                                        <i class="bx bx-pencil nav_icon mx-1" style="vertical-align: middle;"></i>
                                    </a>
                                    <a class="btn btn-outline-danger btn-del" role="button" onclick="deleteConfirm('{{$user->id}}')">
