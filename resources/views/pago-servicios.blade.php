        ...
        <div class=" bg-light">
            ...
            <div class="d-flex justify-content-center">
                <div class="card col-6">
                    <div class="card-body">
                        <form class="needs-validation" novalidate action="/servicios/guardar" method="POST">
                            @csrf
                            {{ method_field('POST') }}
                            <div class="form-group col-12">
                                <label for="">Numero Recivo:</label>
                                <input type="number" class="form-control" name="numeroRecibo" id="numeroRecibo" required>
                                ...
                                <br>
                                <input type="hidden" name="idTipoServicio" id="idTipoServicio" value="{{$id}}">
