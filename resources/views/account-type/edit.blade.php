            ...
            <div class="d-flex justify-content-center mt-5">
                <div class="card col-lg-6 col-sm-12">
                    <div class="card-body">
                        ...
                        <form class="needs-validation row" novalidate action="/admin/tipo-cuenta/editar/{{$tipoCuenta->id}}" method="POST">
                            @csrf
                            {{ method_field('PUT') }}
                            <div class="form-group col-md-12 my-2">
                                <label for="">Tipo:</label>
                                <input type="text" class="form-control" name="nombre" value="{{$tipoCuenta->nombre}}" >
            ...
            function cancelConfirm() {
                Swal.fire({
                    ...
                    if(result.isConfirmed) {
                        window.location.replace('/admin/tipo-cuenta')
                    }
                })
            }
            (() => {
