    ...
    <body id="body-pd" style="background-color: #F7F6FB;">
        ...
        <script>
            ...
            function deleteConfirm($id) {
                Swal.fire({
                    ...
                    if(result.isConfirmed) {
                        window.location.replace('/admin/bancos/eliminar/'+$id)
                    }
                })
            }
        ...
        <div class=" bg-light">
            ...
            <div class="d-flex justify-content-between my-3 mx-3">
                ...
                <a href="/admin/bancos/crear" class="btn btn-outline-secondary btn-add" >
            ...
            <div class="mx-3">
                    ...
                    <div class="card col-12 m-2">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h5 class="fw-bolder">{{ $banco->nombre }}</h5>
                                    <h6>Fecha creación: {{ $banco->created_at }}</h6>
                                    <h6>Última modificación: {{ $banco->updated_at }}</h6>
                                </div>
                                <div>
                                    <a class="btn btn-outline-primary btn-edit" href="/admin/bancos/editar/{{$banco->id}}">
                                        <i class="bx bx-pencil nav_icon mx-1" style="vertical-align: middle;"></i>
                                    </a>
                                    <a class="btn btn-outline-danger btn-del" role="button" onclick="deleteConfirm('{{$banco->id}}')">
                ...
                <div class="">
                    {{ $bancos->links('vendor.pagination.bootstrap-4') }}
                </div>
            </div>
            <!-- data list -->
        </div>
