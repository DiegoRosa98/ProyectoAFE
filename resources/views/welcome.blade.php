        ...
        <div class="container">
            <div class="card">
                ...
                @endif
                    ...
                    <div class="row">
                        <div class="col-md-7 col-sm-12 col-lg-6 d-flex align-items-center justify-content-center">
                            <img src="{{ asset('img/torrefutura.jpg') }}" alt="logo" class="d-flex py-2" style="max-width: 90%;">
                            <!-- <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 text-gray-700 sm:h-20" style="margin-left: 10%;">
                        ...
                        <div class="col-md-5 col-sm-12 ps-2">
