    ...
    <body id="body-pd" style="background-color: #F7F6FB;">
        ...
        <div class=" bg-light">
            ...
            <div class="row mx-2 my-3">
                <div class="card col-md-5 col-sm-12 m-1">
                    <div class="card-body">
                ...
                <div class="card col-md-6 col-sm-12 m-1">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex">
                                <i class="bx bxs-user-check nav_icon mx-1" style="vertical-align: middle;"></i>
                ...
                <div class="card col-md-5 col-sm-12 m-1">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex">
                                <i class="bx bxs-bank nav_icon mx-1" style="vertical-align: middle;"></i>
                                <h5>Gestión de Bancos</h5>
                            </div>
                            <a href="#">
                                <i class="bx bx-chevron-right nav_icon mx-1"></i>
                            </a>
                ...
                <div class="card col-md-6 col-sm-12 m-1">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex">
                                <i class="bx bx-abacus nav_icon mx-1" style="vertical-align: middle;"></i>
                                <h5>Configuración de Tipos de Cuentas</h5>
                            </div>
                            <a href="#">
                                <i class="bx bx-chevron-right nav_icon mx-1"></i>
                            </a>
                ...
                <div class="card col-md-6 col-sm-12 m-1">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex">
                                <i class="bx bx-album nav_icon mx-1" style="vertical-align: middle;"></i>
                                <h5>Configuración de Tipo de Servicios</h5>
                            </div>
                            <a href="#">
                                <i class="bx bx-chevron-right nav_icon mx-1"></i>
                            </a>
