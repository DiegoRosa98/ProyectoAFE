    ...
    <body id="body-pd" style="background-color: #F7F6FB;">
        ...
        <script>
            ...
            function deleteConfirm($id) {
                Swal.fire({
                    ...
                    if(result.isConfirmed) {
                        window.location.replace('/admin/cuentas/eliminar/'+$id)
                    }
                })
            }
        ...
        <div class=" bg-light">
            ...
            <div class="d-flex justify-content-between my-3 mx-3">
                ...
                <a href="/admin/cuentas/crear" class="btn btn-outline-secondary btn-add" >
            ...
            <div class="mx-3">
                ...
                <div class="">
                    {{ $cuentas->links('vendor.pagination.bootstrap-4') }}
                </div>
            </div>
            <!-- data list -->
        </div>
